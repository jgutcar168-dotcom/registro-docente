...
# --- 1. CONFIGURACIÓN ---
st.set_page_config(page_title="Registro Docente | Ángela Ortiz", layout="wide")
...
class EvaluacionPDF(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 5, "Maestra Especialista: Ángela Ortiz Ordónez", ln=True, align="C")
        self.ln(10)
...
st.markdown("""
    <div style="background-color: #f0f2f6; padding: 20px; border-radius: 10px; border-left: 8px solid #4f64af; margin-bottom: 20px;">
        ...
        <p style="margin: 0; color: #4f64af; font-size: 1.2rem; font-weight: bold;">Maestra Especialista: <span style="color: #ff6e40;">Ángela Ortiz Ordónez</span></p>
    </div>
