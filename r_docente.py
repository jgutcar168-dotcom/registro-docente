...
# --- 2. CLASE PDF CON COLUMNAS SOMBREADAS ---
class EvaluacionPDF(FPDF):
    ...
    def tabla_maestra(self, items):
        ...
        self.set_fill_color(230, 230, 230) # Gris para encabezados
        ...
        for it in items:
            ...
            for i, t in enumerate(textos):
                # --- MEJORA: Sombreado de las dos primeras columnas ---
                if i < 2: 
                    self.set_fill_color(245, 245, 245) # Gris muy claro para Letra y Descripción
                    relleno = True
                else:
                    relleno = False
                
                # Dibujamos el rectángulo con o sin relleno
                self.rect(x_ini, y_ini, w[i], h_fila, style='FD' if relleno else 'D')
