        ...
        with st.form("f_ev"):
            ...
            for a in res_a:
                if a["curso"] != curso_actual:
                    ...
                    lista_alumnos.append(f"--- {curso_actual} ---")
                lista_alumnos.append(f"{a['nombre']} ({a['curso']})")

            al_ev = c1.selectbox("Alumno", lista_alumnos)

            # ❗ IMPORTANTE: este bloque DEBE ir dentro del form
            if al_ev.startswith("---"):
            ...
            # ✔ AHORA Streamlit sí detecta el botón dentro del formulario
